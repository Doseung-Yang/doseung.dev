...
function DropdownMenu({ item }: { item: DropdownLink }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-full left-0 mt-2 min-w-[180px] py-2 bg-background/95 backdrop-blur-xl border border-border rounded-xl shadow-xl transition-all duration-200 origin-top ${
          isOpen
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <ThemeToggle />
            <button className="sm:hidden p-2 rounded-lg hover:bg-accent transition-colors">
